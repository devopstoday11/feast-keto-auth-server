...
public class OpenAPIDocumentationConfig {
    ...
    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.feastAuthorizationServer.base-path:}") String basePath) {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("feast.auth.providers.http.ketoadaptor.api"))
                    .build()
