...
public class CheckAccessApiController implements CheckAccessApi {
  ...
  public void setKetoAuth(KetoAuth ketoAuth) {
    this.ketoAuth = ketoAuth;
  }

  @Bean
  public KetoAuth getKetoAuth() {
    if (ketoAuth == null) {
      ketoAuth = new KetoAuth(ketoProperties.getUrl());
    }
    return this.ketoAuth;
  }
}
